# Mriya46 MX — ZMK config

ZMK firmware configuration for the Mriya46 split keyboard (MX switches, nRF52840).
...
```sh
make mriya46-mx                    # every firmware target of this keyboard
make mriya46-mx-left-studio        # a single target
make ZMK_REV=main PRISTINE=1 mriya46-mx   # against ZMK main (uses hwmv2 board)
```
